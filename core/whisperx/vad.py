            ...
            for t, y in zip(timestamps[1:], k_scores[1:]):
                ...
                if is_active:
                    ...
                    if curr_duration > self.max_duration:
                        ...
                        # divide segment
                        min_score_div_idx = search_after + \
                            np.argmin(curr_scores[search_after:])
                        min_score_t = curr_timestamps[min_score_div_idx]
                        region = Segment(start - self.pad_onset,
                                         min_score_t + self.pad_offset)
...
class VoiceActivitySegmentation(VoiceActivityDetection):
    def __init__(
        ...
        **inference_kwargs,
        ...
        super().__init__(segmentation=segmentation, fscore=fscore,
                         use_auth_token=use_auth_token, **inference_kwargs)
